...
// hyper and esc on caps lock
#define ESC_HYP HYPR_T(KC_ESC)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_60_ansi(
    ...
    ESC_HYP, KC_A,    HOME_S,  HOME_D,  HOME_F,  KC_G,    KC_H,   HOME_J,  HOME_K,  HOME_L,  KC_SCLN, KC_QUOT,           KC_ENT,
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,   KC_M,    KC_COMM, KC_DOT,  KC_SLSH,                    UP_ARR,
    KC_LCTL, KC_LALT, KC_LGUI,                            LT(1,KC_SPC),                      KC_RGUI, LFT_ARR, DWN_ARR,  RGT_ARR
  ),
