...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_FN_SYMBOLS] = LAYOUT_60_ansi(
    ...
    _______, _______, _______, KC_UNDS, KC_MINS, _______, _______, _______,   _______,  _______, _______,                   _______,
  ...
  [_MEDIA] = LAYOUT_60_ansi(
    ...
    _______, _______, _______, _______, _______, _______, KC_MS_L, KC_MS_D, KC_MS_D, KC_MS_R, _______, _______,          _______,
